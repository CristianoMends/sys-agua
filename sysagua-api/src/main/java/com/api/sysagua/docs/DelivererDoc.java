...
public interface DelivererDoc {
    ...
    ResponseEntity<Void> create(CreateDelivererDto dto);
    ...
    ResponseEntity<List<Deliverer>> list(
            Long id,
            String name,
            String phone);
    ...
    ResponseEntity<Void> update(Long id, UpdateDelivererDto dto);
}
