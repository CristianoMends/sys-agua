...
public class TransactionService {
    ...
    public List<Transaction> buscarTransacaoCompraId(Long id, String token) throws Exception {
        ...
        if (response.statusCode() == 200) {
            ...
            List<Transaction> transacoes = objectMapper.readValue(response.body(), new TypeReference<List<Transaction>>() {});
